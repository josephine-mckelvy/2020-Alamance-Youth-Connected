...
I will be keeping columns 12 through 67, and then 75 through 113 of the dataframe.
```{r}
...
```{r}
ppt.df[7:11] <- lapply(ppt.df[7:11], cleanIt) #racial identity options are columns 7 through 11
...
pretest.df <- ppt.df [ppt.df$`Group Name`=="payc" & ppt.df$Time=="Before",] #all the questions for this group in their pretest
