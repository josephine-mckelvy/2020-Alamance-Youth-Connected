...
```{r}
ppt.df <- raw.df[3:nrow(raw.df),c(12:67,75:113)] #11 obs, 95 variables
...
ppt.df$`I felt judgedR` <- 4-ppt.df$`I felt judged` #NAs introduced by coercion

ppt.df$`I felt uncomfortable participating` <- as.numeric(as.character(ppt.df$`I felt uncomfortable participating`))
ppt.df$`I felt uncomfortable participatingR` <- 4=ppt.df$`I felt uncomfortable participating` #on a scale of 1 to 3
```
...
ppt.df$Q4 <- tolower(ppt.df$Q4) #lowercase that group name to standardize it

demo.df <- ppt.df [ppt.df$Q4=="payc" & ppt.df$Q3=="Before",c(12:55,109:114)] #demographics/experiences & thoughts from pre-test for a specific group
post.df <- ppt.df [ppt.df$Q4=="payc" & ppt.df$Q3=="After",] #post-test only for a specific group
ksa.df <- ppt.df [ppt.df$Q4=="payc" & ppt.df$Q3=="Before" | ppt.df$Q3=="After",c(12,77:108)] #KSAs before and after EBP for a specific group with identifier
thoughts.df <- ppt.df[ppt.df$Q4=="payc" & ppt.df$Q3=="Before" | ppt.df$Q3=="After",c(12, 109:114)] #thoughts before and after EBP for a specific group with identifier
