...
pre.df <- rawppt.df[2:nrow(rawobs.df),c(12:57,79:115)] #demographics, pre-test
post.df <- rawppt.df[2:nrow(rawobs.df),c(12:14,58:69,77:115)]#identifiers, satisfaction, contact info to post-test
