...
# P/PT Thoughts codebook: 1=disagree; 2=not sure; 3=agree; 4=not applicable to me (replaced with NA);
...
ptdemographics.df <- ppt.df[ppt.df$`Group Name`=="sabgc042021" & ppt.df$Time=="Before",c(1,3,4,6:13,15,16,18:22,24,26:45)] #9 Demographic variables
