...
ptthoughts.df     <- ppt.df[ppt.df$`Group Name`=="dreamcenter032421",c(1,3,93:97)] #5 Thought variables (likert) for Pre AND Post
...
tab_xtab(var.row = ptdemographics.df$race_cat, var.col = ptdemographics.df$Hispanic,
         title = "Race by Ethnicity for: SABGC042021",
         file = "SABGC042021 - OAH Race by Ethnicity Table.doc")
...
ggsave("DreamCenter032421 - Satisfaction.png", width = 9, height = 3.25)
```
