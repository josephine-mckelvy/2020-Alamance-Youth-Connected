...
ppt.df$multiracial <- 0
multiracial <- rowSums()
ppt.df$race = (ppt.df$White + ppt.df$Black + ppt.df$Asian + ppt.df$`Pacific Islander` + ppt.df$`Native American`)
#if race >=2, multiracial=1; but still double counting that person
