...
lead <- ELON.df[c(73,5:44)] #time, leadership scales 5:44
lead <- na.omit(lead)

staff <- ELON.df[c(73,45:72)] #time, sup/fac scales 45:72
staff <- na.omit(staff)

library(likert)
#leadership
leadpolicy <- likert(lead[,2:5], grouping = lead$Time) #2:5
...
leadpartner <- likert(lead[,6:9], grouping = lead$Time) #6:9
...
leadsustain <- likert(lead[,10:13], grouping = lead$Time) #10:13
...
leadimpl <- likert(lead[,14:18], grouping = lead$Time) #14:18
...
leadeval <- likert(lead[,19:23], grouping = lead$Time) #19:23
...
leadtia <- likert(lead[,24:29], grouping = lead$Time) #24:29
...
leadpyd <- likert(lead[,30:32], grouping = lead$Time) #30:32
...
leadlgbt <- likert(lead[,33:41], grouping = lead$Time) #33:41
