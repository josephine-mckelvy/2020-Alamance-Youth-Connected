...
library(likert)
###################################
# all IOs, all responses together #
###################################

# Leadership (all IOs, cross-sectional, by area)
...
#Supervisors/Facilitators (all IOs, cross-sectional, by area)
...
#Leadership (all IOs, longitudinal, by area)
...
ggsave("TIA (Leadership) - 12.png", height = 7)
...
ggsave("PYD (Leadership) - 12.png", height = 3)
...
ggsave("LGBTQ (Leadership) - 12.png", height = 12)

#Supervisors/Facilitators (all IOs, longitudinal, by area)
...
ggsave("Implementation (Staff) - 12.png", height = 15)
...
ggsave("TIA (Staff) - 12.png", height = 7)
...
ggsave("LGBTQ (Staff) - 12.png", height = 7) 
...
ggsave("PYD (Staff) - 12.png", height = 6.5)

##################################
# by IOs, all responses together #
##################################
