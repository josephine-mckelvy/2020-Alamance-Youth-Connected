...
gender <- data.frame(Demographics=c("Male","Female","Transgender","Does not identify","Gender not reported"),Freq=c(7,4,0,0,0))
race <- data.frame(Demographics=c("White","Black","Asian","Alaska Native", "Native Hawaiian","Multiracial", "Race not Reported"),Freq=c(0,10,0,0,0,1,0))
...
tab_df(payc022521,
       ...
       file = "PAYC022521 Demographics Table.doc")
```
...
ggsave("PAYC022521 Experiences.png", width = 9, height = 2.5)
...
ggsave("PAYC022521 Thoughts.png", width = 9, height = 6)
```
