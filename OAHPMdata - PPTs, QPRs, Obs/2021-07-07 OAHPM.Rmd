...
qpr1 <- flqpr.df[flqpr.df$`QPR period` %like% year & flqpr.df$`QPR ebp`==curr, c(95,96,100:102)]
qpr2 <- flqpr.df[flqpr.df$`QPR period` %like% year & flqpr.df$`QPR ebp`==curr, c(108,109,113:115)]
qpr3 <- flqpr.df[flqpr.df$`QPR period` %like% year & flqpr.df$`QPR ebp`==curr, c(121,122,126:128)]
qpr4 <- flqpr.df[flqpr.df$`QPR period` %like% year & flqpr.df$`QPR ebp`==curr, c(134,135,139:141)]
