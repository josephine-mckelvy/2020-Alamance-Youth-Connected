...
# OR
rawppt.df <- read.csv("Participant Pre  Post Test Survey IN-clued.csv", stringsAsFactors = TRUE)

#English Pre/Post-Tests: subsetted dataframe for IN-clued
pptengl.df <- rawppt.df[2:nrow(rawppt.df),c(3,11:69,77:80,86:93)] #72 variables for IN-clued
...
pptengl.df[68:85] <- lapply(pptengl.df[68:85], cleanIt) #both: if used correctly Qs in MPC only
