...
pptengl.df <- rawppt.df[2:nrow(rawppt.df),c(3,11:69,77:93)] #need names of IN-clued PPT
...
###########################
gpthoughts.df <- pptengl.df[pptengl.df$`Group Name` %like% thisgroup,c(100,4,6,95:99)] #5 Thought variables (likert) for Pre AND Post
...
gpdemographics.df <- pptengl.df[pptengl.df$`Group Name` %like% thisgroup & pptengl.df$Time=="Before",c(4,100,3,9:15,17,18,20:24,26)] #8 Demographic variables 
...
library(sjPlot)
tab_df(reach,
       title = "Reach for: Elon082421",
       file = "Elon - Demographics Table.doc")
